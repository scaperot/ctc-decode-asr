...
'''
Take a single song and break up into ~15s chunks in accordances with Stoller's 
'End to end lyrics alignment for polyphonic music using an audio-to-character 
 recogition model.'

Data Metadata Format
- 225501 samples @22050Hz (10.23s)
...
def is_song_trainable(dali_data):
    ...
    - TODO: blacklist for poorly transcribed songs (manual analysis)
